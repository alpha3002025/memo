...
위의 이유로 테스트 해봤는데... `3.0 pro`는 개뿔 Gemini CLI 에서는 아직 2.5 까지만 사용 가능한 것으로 github repository 에 적혀있었다. 그래도 가격이 저렴해서... 이제 점점 Claude Code 와 멀어질 기회를 잡아가야할까 싶다.<br/>
<br/>
...
인증 완료 후에는 다음의 화면이 나타난다.  
![](./img/0-gemini-cli-start/5.png)

- Gemini Code Assist : https://developers.google.com/gemini-code-assist/docs/overview?hl=ko
- Gemini Code Assist 를 사용한 Cloud Code : https://cloud.google.com/code/docs/shell/write-code-gemini?hl=ko 
